...
TetrisIcon = pygame.image.load(os.path.join(img_folder, "videogame.bmp"))
Images = [["tetrisL.bmp"], ["tetrisZ.bmp"], ["tetrisZmirror.bmp"], ["tetrisLine.bmp"], ["tetrisLmirror.bmp"],
          ["tetrisSquare.bmp"], ["tetrisT.bmp"]]

Hold_Images = [["tetrisLimg.bmp", "tetrisLimg1.bmp", "tetrisLimg2.bmp", "tetrisLimg3.bmp"],
               ["tetrisZimg.bmp", "tetrisZimg1.bmp"], ["tetrisZmirrorimg.bmp", "tetrisZmirrorimg1.bmp"]
    , ["tetrisLineimg.bmp", "tetrisLineimg1.bmp"],
               ["tetrisLmirrorimg.bmp", "tetrisLmirrorimg1.bmp", "tetrisLmirrorimg2.bmp", "tetrisLmirrorimg3.bmp"],
               ["tetrisSquareimg.bmp"],
               ["tetrisTimg.bmp", "tetrisTimg1.bmp", "tetrisTimg2.bmp", "tetrisTimg3.bmp"]]
...
def Score_Display():
    ...
    text_rect.center = Mainrect.center
...
def display_hold():
    ...
    text_rect2.center = text_rect1.center
    text_rect2.y += 50
    Disp.blit(text2, text_rect2)
    if holdelement[0] != -1:
        image = pygame.image.load(os.path.join(img_folder, Hold_Images[holdelement[0]][holdelement[1]])).convert_alpha()
...
def next_display():
    ...
    image1 = pygame.image.load(os.path.join(img_folder, Hold_Images[nextlist[1]][0])).convert_alpha()
    image_rect1 = image1.get_rect()
    image_rect1.center = next_rect1.center
    Disp.blit(image1, image_rect1)
    image2 = pygame.image.load(os.path.join(img_folder, Hold_Images[nextlist[2]][0])).convert_alpha()
    image_rect2 = image2.get_rect()
    image_rect2.center = next_rect2.center
    Disp.blit(image2, image_rect2)
    image3 = pygame.image.load(os.path.join(img_folder, Hold_Images[nextlist[3]][0])).convert_alpha()
...
class obj(pygame.sprite.Sprite):
    ...
    def __init__(self, shapevar):
        ...
        self.image = pygame.image.load(os.path.join(img_folder, Images[shapevar][0])).convert_alpha()
